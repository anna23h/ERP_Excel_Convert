...
setlocal
REM ============================================
REM Build Reorder Helper into a single-file Windows exe.
REM Keep this .bat ASCII-only (non-ASCII breaks on GBK consoles).
REM ============================================
...
echo.
echo Done. exe is at: dist\ReorderHelper.exe
goto end
